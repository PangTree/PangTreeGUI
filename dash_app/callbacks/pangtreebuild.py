...
from dash_app.components.pages import get_task_description_layout
from dash_app.app import app


def get_success_info(message):
    return [
        html.I(className="fas fa-check-circle correct"),
...
def get_error_info(message):
    return [
        html.I(className="fas fa-exclamation-circle incorrect"),
        html.P(message, style={"display": "inline", "margin-left": "10px"})
    ]
...
@app.callback(
    Output("metadata_upload_state", 'data'),
    [
...
@app.callback(
    Output("metadata_upload_state_info", 'children'),
    [
...
@app.callback(
    Output("multialignment_upload_state", 'data'),
    [
...
@app.callback(
    Output("multialignment_upload_state_info", 'children'),
    [
...
@app.callback(
    Output("maf_specific_params", 'is_open'),
    [
        Input("multialignment_upload_state", 'data')
    ]
)
...
@app.callback(
    [
        Output("missing_symbol_param", 'is_open'),
...
@app.callback(
    Output("fasta_upload_state", 'data'),
    [
...
@app.callback(
    Output("fasta_upload_state_info", 'children'),
    [
...
@app.callback(
    Output("blosum_upload_state_info", 'children'),
    [
...
@app.callback(
    [
        Output("poa_specific_params", 'is_open'),
...
@app.callback(
    Output("poapangenome_result", "is_open"),
    [
        Input("session_state", 'data')
    ]
)
...
@app.callback(
    Output("poapangenome_result_description", "children"),
    [
        Input("session_state", 'data')
    ]
)
