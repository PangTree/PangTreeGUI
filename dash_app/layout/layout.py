    ...
    dcc.Tabs(
        ...
        children=[
            dcc.Tab(
                ...
                children=about.get_about_tab_content()
            ),
            dcc.Tab(
                label='Online Tools',
                value='tools',
            ...
            dcc.Tab(
                ...
                className='custom-tab',
                selected_className='custom-tab--selected',
                children=package.get_package_tab_content()
            ),
            dcc.Tab(
                label='Authors',
                value='authors', className='custom-tab',
                selected_className='custom-tab--selected',
                children=authors.get_authors_tab_content()
            )
        ]),
        html.Div(
            id=id_hidenn_divs,
        ...
        #         children=[
        #             html.H1(
        #                 'Multiple sequence alignment: analysis & visualisation',
        #                 id=id_title,
        ...
        #         children=[
        #             # dcc.Tabs(
        #             #     id="tabs-example", value='tab-1-example',
        #             #     children=[
        ...
        #                                         id="program_run",
        #                                         children=[
        #                                             html.H5("Poagraph build parameters"),
        #                                             dcc.Upload(
        #                                                 id="maf_upload",
        #                                                 children=[
        #                                                     html.Img(
        ...
        #                                                 className='file_upload'
        #                                             ),
        #                                             html.P("Fasta provider: "),
        #                                             dcc.Dropdown(options=[
        #                                                                 {'label': 'NCBI', 'value': 'NCBI'},
        #                                                                 {'label': 'Local file', 'value': 'LOCAL'}
        #                                                             ],
        #                                                             value='NCBI', className='form_item'),
        #                                             html.P("Data type: "),
        #                                             dcc.Dropdown(value='N',
        #                                                          options=[
        #                                                              {'label': 'Nucleotides', 'value': 'N'},
        #                                                              {'label': 'Local file', 'value': 'L'}
        #                                                          ], className='form_item'),
        #
        #                                             html.P("Convert to DAG?"),
        #                                             dcc.Checklist(
        #                                                 options=[
        #                                                     {'label': 'YES', 'value': 'DAG'}
        #                                                 ],
        #                                                 values=['DAG'], className='form_item'
        #                                             ),
        ...
        #                                                         children=[
        #                                                             html.P("Range", className='form_item_label', style={'display': None},),
        ...
        #                                             children=[
        #                                                 dcc.Markdown(texts.table_info_markdown,
        #                                                              className='ten columns'),
